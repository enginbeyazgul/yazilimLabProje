            ...
            <form action="{{route('ogrencimain/intibak')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="ders5">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="u5" value="{{ old('u5') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="l5" value="{{ old('l5') }}" placeholder="L" type="text">
                ...
                <div class="ders6">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="u6" value="{{ old('u6') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="l6" value="{{ old('l6') }}" placeholder="L" type="text">
                ...
                <div class="ders7">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="u7" value="{{ old('u7') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="l7" value="{{ old('l7') }}" placeholder="L" type="text">
                ...
                <div class="ders">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="um" value="{{ old('um') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="lm" value="{{ old('lm') }}" placeholder="L" type="text">
                ...
                <div class="ders2">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="u2m" value="{{ old('u2m') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="l2m" value="{{ old('l2m') }}" placeholder="L" type="text">
                ...
                <div class="ders3">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="u3m" value="{{ old('u3m') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="l3m" value="{{ old('l3m') }}" placeholder="L" type="text">
                ...
                <div class="ders4">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="u4m" value="{{ old('u4m') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="l4m" value="{{ old('l4m') }}" placeholder="L" type="text">
                ...
                <div class="ders5">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="u5m" value="{{ old('u5m') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="l5m" value="{{ old('l5m') }}" placeholder="L" type="text">
                ...
                <div class="ders6">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="u6m" value="{{ old('u6m') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="l6m" value="{{ old('l6m') }}" placeholder="L" type="text">
                ...
                <div class="ders7">
                    ...
                    <div class="row">
                        ...
                        <input style="width: 40px; margin-left: 10px" name="u7m" value="{{ old('u7m') }}" placeholder="U" type="text">
                        <input style="width: 40px; margin-left: 10px" name="l7m" value="{{ old('l7m') }}" placeholder="L" type="text">
